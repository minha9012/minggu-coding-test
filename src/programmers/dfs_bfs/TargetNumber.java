 ...
 *
 * 프로그래머스 - 깊이/너비 우선 탐색(DFS/BFS) - Level 2 - 타겟 넘버
 *
 * 문제 설명
...
public class TargetNumber {
    ...
    private static final int[] input1 = {1, 1, 1, 1, 1}; //expect 5
    private static final int target1 = 3;
    private static final int[] input2 = {4, 1, 2, 1}; //expect 2
    private static final int target2 = 4;
